...
import {SUBAGENTS,reqItem,reqItemModes,reqItemSupported,reqPurchase,reconPulseTargets,repairToolTarget,sentryDeployment,spotDroneTargets} from '../game/cocs-economy.mjs';
