...
const versions={
 '2d6b7e66-6adc-43f2-b29e-9d26fed86387':'460674e',
 'cfb8c298-c0e0-4337-9951-75b7bcc734a3':'12e0707',
};
const index={base:'ffa6aac0bc4a61a0b5e1721dbb4000066c22a474',evidence:[]};
for(const [id,revision]of Object.entries(versions)){
 ...
 assert.equal(sha(readFileSync(launch.binary)),launch.binarySHA256);
 ...
 index.evidence.push({id,originalExit:summary.exit,exactLiveCommit:commit,runtimeHashesMatched:Object.keys(summary.runtimeHashes).length,source:summary.source,binarySHA256:launch.binarySHA256,cleanupIndependentlyAbsent:true,files});
}
