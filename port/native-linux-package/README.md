...
- All eight scene paths are exported: combat, sports, objectives, LATTICE board,
  LATTICE world, zones, combined arms and Arms Race. Routing is package-local and does
...
executable/PCK. It verifies all nine semantic maps, all eight compiled scenes,
