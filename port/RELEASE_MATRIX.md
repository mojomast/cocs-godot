...
| Native CI | Official pinned archive/hash, fresh npm install and GLB generation checked | Hosted successes and original audio failure retained | Ubuntu GitHub Actions run `35679675460` passes all 59 gates at `424f74f`, including co-op economy and soccer guidance | Fresh-checkout automation accepted; graphical/hardware gameplay separate |
