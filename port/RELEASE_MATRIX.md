...
| Native CI | Official pinned archive/hash, fresh npm install and GLB generation checked | Hosted successes and original audio failure retained | Ubuntu GitHub Actions run `35694780087` passes all87 gates at `1cbc04d`; complete downloaded summary retained | Horde source/adapter/input/closure/ownership gates confirmed hosted; graphical/package evidence remains separate |
...
| Full verifier | All **87** implemented gates pass after local Horde integration | Original failures retained and corrected | Complete rerun includes Horde source70/adapter50/model15/input31/look3, closure/public-Room boundary and ownership30 tests | See `reports/verification.json`; graphical/playable gates separate |
...
- The combined 87-gate verifier passes with rocket presentation, sports
