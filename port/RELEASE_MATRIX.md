...
| Native CI | Official pinned archive/hash, fresh npm install and GLB generation checked | Hosted successes and original audio failure retained | Ubuntu GitHub Actions run `35687499645` passes all73 gates at `9c9e5de`; complete downloaded summary retained | Collector fix confirmed hosted: current summary survives80-file cap; five optional logs omitted |
