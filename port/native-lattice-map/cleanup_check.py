"""Inspect recorded ports and this isolated worktree's native/server/Xvfb children."""
import json
import os
...
evidence = root / 'port/native-lattice-map/evidence'
...
for path in Path('/proc').iterdir():
    ...
    try:
        ...
        if any(b'Godot_v' in arg or b'Xvfb' in arg or arg in [b'port/native-lattice-map/run.mjs', b'port/native-lattice-physical/run.mjs'] for arg in command):
