...
const TABLE := {
	"pearl-ceramic": {
		...
		"default": {"base": "hex_paneling-mottle", "normal": "hex_paneling-mottle", "normal_source": "derived"},
		"variants": {
			...
			"worn": {"base": "weathered_concrete-worn", "normal": "weathered_concrete-worn", "normal_source": "derived", "params": {"roughness": 0.58, "metallic": 0.03}},
		},
	...
	"enamel-glaze": {
		...
		"variants": {
			"stucco": {"base": "rough_stucco-weathered", "normal": "rough_stucco-weathered", "normal_source": "derived", "params": {"roughness": 0.34, "tiles_per_metre": 1.0}},
			"crackle": {"base": "ice-cracked", "normal": "ice-cracked", "normal_source": "derived", "params": {"roughness": 0.18, "albedo_gain": 2.4}},
			"damp": {"base": "weathered_concrete-damp", "normal": "weathered_concrete-damp", "normal_source": "derived", "params": {"roughness": 0.24, "albedo_gain": 3.2}},
		},
	...
	"brushed-alloy": {
		...
		"variants": {
			...
			"circuit": {"base": "circuit_board-etch", "normal": "circuit_board-etch", "normal_source": "derived", "mask": "mask--circuit_board", "mask_strength": 0.8, "params": {"lut_gain": 0.7, "accent_mask_strength": 0.8}},
		},
	...
	"oxidised-copper": {
		...
		"default": {"base": "metal-oxide", "normal": "metal-oxide", "normal_source": "derived"},
		"variants": {
			"scorched": {"base": "riveted_armor-scorched", "normal": "riveted_armor-scorched", "normal_source": "derived", "params": {"texture_saturation": 0.35, "metallic": 0.5}},
	...
	"bioluminescent-membrane": {
		...
		"variants": {
			...
			"matrix": {"base": "macro-organic", "normal": "macro-organic", "normal_source": "derived", "linear_base": true, "params": {"albedo_gain": 1.6, "roughness": 0.55}},
		},
	...
	"regolith": {
		...
		"variants": {
			...
			"mossy": {"base": "rock-moss", "normal": "rock-moss", "normal_source": "derived", "params": {"albedo_gain": 2.4, "tint": Color("b8bfa4")}},
